...
exports.parseToJson = exports.convertNumberStringToArray = exports.toBoolean = exports.generateSlug = exports.videoFileFilter = exports.imageFileFilter = exports.fileExtensionFilter = exports.getSesObject = exports.getWasabiS3Object = exports.getS3Object = void 0;
...
function parseToJson(value, validationDTO) {
    try {
        // let parsed = undefined
        if (typeof value === 'string' && !(value === null || value === void 0 ? void 0 : value.length))
            throw Error('Input value must be a non-empty JSON string');
        var parsed = typeof value === 'string' ? JSON.parse(/%[0-9A-Fa-f]{2}/.test(value) ? decodeURIComponent(value) : value) : value;
        // Return transformed data based on the type of parsed value
        return Array.isArray(parsed)
            ? parsed.map(function (item) { return class_transformer_1.plainToInstance(validationDTO, item); })
            : parsed && typeof parsed === 'object'
                ? class_transformer_1.plainToInstance(validationDTO, parsed)
                : (function () {
        ...
        throw new common_1.BadRequestException("Failed to parse value: " + (error === null || error === void 0 ? void 0 : error['message']), parseToJson.name);
    }
}
