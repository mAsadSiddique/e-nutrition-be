export enum RESPONSE_MESSAGES {
	...
	CATEGORY_REQUIRED_FOR_BLOG = 'Category is required before publishing the blog',
	BLOG_CANNOT_BE_PUBLISHED_WITHOUT_CATEGORY = 'Blog cannot be published without selecting a category',
