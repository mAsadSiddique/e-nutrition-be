...
(function (RESPONSE_MESSAGES) {
  ...
  RESPONSE_MESSAGES["UserAlreadyExist"] = "User already exist"; // Admin
  ...
  RESPONSE_MESSAGES["ADMIN_ROLE_UPDATED"] = "Admin role updated successfully"; // Password
  ...
  RESPONSE_MESSAGES["UserPasswordUpdated"] = "User password updated successfully"; // CANT_CHANGE_PASSWORD = `you can't change password until your are registered with email and password`,
  // Self
  ...
  RESPONSE_MESSAGES["SELF_LEAVING_NOT_ALLOWED"] = "self leaving is not allowed"; // Email
  ...
  RESPONSE_MESSAGES["EmailResetCodeSent"] = "Reset password code sent to your email, please check your inbox"; // Phone Number
  ...
  RESPONSE_MESSAGES["PhoneResetCodeSent"] = "Reset password code sent to your phone, please check your messages"; // JWt
  ...
  RESPONSE_MESSAGES["JWT_OR_CODE_REQUIRED"] = "jwtToken or 6 digit code is required"; // Profile

  RESPONSE_MESSAGES["PROFILE_UPDATED"] = "Profile updated successfully"; // Address
  ...
  RESPONSE_MESSAGES["INVALID_ADDRESS"] = "invalid address"; // category
  ...
  RESPONSE_MESSAGES["CATEGORY_ALREADY_EXIST_WITH_NAME"] = "Category already exist with the same name"; // images
  ...
  RESPONSE_MESSAGES["DIMS_REQUIRED"] = "dims is required for each image"; // Role
  ...
  RESPONSE_MESSAGES["ROLE_UPDATED"] = "role updated successfully"; // Generic Error Message
  ...
  RESPONSE_MESSAGES["FROM_DATE_MUST_BE_GREATER_THAN_TO_DATE"] = "From date must be greater than to date"; // Verifications
