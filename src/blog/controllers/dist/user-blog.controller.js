...
exports.UserBlogController = void 0;
var common_1 = require("@nestjs/common");
var swagger_1 = require("@nestjs/swagger");
var blog_entity_1 = require("../entities/blog.entity");
var user_auth_guard_1 = require("../../auth/guard/user_auth.guard");
...
var UserBlogController = /** @class */ (function () {
    function UserBlogController(blogService) {
        this.blogService = blogService;
    }
    UserBlogController.prototype.getUserBlogs = function (args, user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blogService.getUserBlogs(user.id, args.page, args.limit, args.categoryId)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UserBlogController.prototype.getBlogById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    __decorate([
        ...
        common_1.Get('/categories/selected'),
...
exports.UserBlogController = UserBlogController;
