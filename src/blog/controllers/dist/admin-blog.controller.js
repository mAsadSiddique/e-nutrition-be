...
var create_blog_dto_1 = require("../dtos/create-blog.dto");
...
var AdminBlogController = /** @class */ (function () {
    ...
    AdminBlogController.prototype.createBlog = function (args, admin, files) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blogService.createBlog(args, admin.id, files)];
    ...
    AdminBlogController.prototype.updateBlog = function (args, admin, files) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blogService.updateBlog(args, admin.id, files)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        ...
        common_1.UseInterceptors(platform_express_1.FileFieldsInterceptor([
            ...
            limits: {
                fileSize: eval(constant_1.ENV.FILE_SIZE.IMAGE_FILE_SIZE),
                fieldSize: eval(constant_1.ENV.FILE_SIZE.FIELD_SIZE),
                files: 5
            }
        })),
        ...
        swagger_1.ApiBody({
            ...
            type: create_blog_dto_1.CreateBlogDTO
        }),
