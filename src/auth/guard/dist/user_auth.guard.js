...
var UserAuthGuard = /** @class */ (function () {
    function UserAuthGuard(jwtService, exceptionService, sharedService, userAuthService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jwtService.verifyAsync(req.headers.authorization, { secret: constant_1.ENV.JWT.SECRET })];
                    case 1:
                        payload = _a.sent();
                        ...
                        return [4 /*yield*/, this.userAuthService.validateUser(payload.username)
                            // Ensure JWT registrationType overrides DB value for request lifecycle
                        ];
                    case 2:
                        user = _a.sent();
                        // Ensure JWT registrationType overrides DB value for request lifecycle
                        user.registrationType = (payload === null || payload === void 0 ? void 0 : payload.registrationType) || user.registrationType;
                        // Attach user to request for downstream handlers
                        req.user = user;
                        return [2 /*return*/, true];
                    case 3:
                        error_1 = _a.sent();
                        this.sharedService.jwtExceptionDetector(error_1);
                        this.sharedService.sendError(error_1, UserAuthGuard_1.name);
    ...
    var UserAuthGuard_1;
    UserAuthGuard = UserAuthGuard_1 = __decorate([
        common_1.Injectable()
    ], UserAuthGuard);
