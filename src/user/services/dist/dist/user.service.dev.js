...
function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [2
            /*return*/
            , this.sharedService.sendResponse(response_messages_enum_1.RESPONSE_MESSAGES.SUCCESS, responseData)];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            msg = '';
            if (!(args.email && args.email !== user.email)) return [3
            /*break*/
            , 3];
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , this.userAccountService.sendAccountVerificationCode({
              email: args.email
            }, user)];
          ...
          case 3:
            if (!(args.phoneNumber && args.phoneNumber !== user.phoneNumber)) return [3
            /*break*/
            , 6];
          ...
          case 6:
            if (!(args.username && args.username !== user.username)) return [3
            /*break*/
            , 8];
          ...
          case 8:
            ...
            return [4
            /*yield*/
            , queryRunner.manager.update(user_entity_1.User, {
              id: user.id
            }, user)];
          ...
          case 13:
            ...
            return [2
            /*return*/
            , this.sharedService.sendResponse(response_messages_enum_1.RESPONSE_MESSAGES.PROFILE_UPDATED + ((msg === null || msg === void 0 ? void 0 : msg.length) ? " and " + msg : ''), profile === null || profile === void 0 ? void 0 : profile.data)];
        ...
        switch (_a.label) {
          case 0:
            ...
            , queryRunner.manager.update(user_entity_1.User, {
              ...
              userType: user_enums_1.UserTypeEnum.TASKER
            })];
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 4:
            ...
            return [2
            /*return*/
            , this.sharedService.sendResponse(response_messages_enum_1.RESPONSE_MESSAGES.SUCCESS, true)];
  ...
  var UserService_1;
  UserService = UserService_1 = __decorate([common_1.Injectable(), __param(0, typeorm_1.InjectRepository(user_entity_1.User))], UserService);
  return UserService;
}();
